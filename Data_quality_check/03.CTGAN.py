...
SD_healthy_tomato = pd.read_excel(base_path+ r"6.CTGAN\tomato_healthy.xlsx")[:samples]
SD_unhealthy_tomato = pd.read_excel(base_path+ r"6.CTGAN\tomato_unhealthy.xlsx")[:samples]
SD_Capsicum = pd.read_excel(base_path+ r"6.CTGAN\capsicum.xlsx")[:samples]
SD_potato = pd.read_excel(base_path+ r"6.CTGAN\potato.xlsx")[:samples]
SD_chilli = pd.read_excel(base_path+ r"6.CTGAN\chilli.xlsx")[:samples]
SD_mulberry = pd.read_excel(base_path+ r"6.CTGAN\mulberry.xlsx")[:samples]
