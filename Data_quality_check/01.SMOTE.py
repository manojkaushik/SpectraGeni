# -*- coding: utf-8 -*-
"""
Created on Mon Jun 10 14:44:07 2024
...
SD_healthy_tomato = pd.read_excel(base_path+ r"4.SMOTE\tomato_healthy.xlsx")[:samples]
SD_unhealthy_tomato = pd.read_excel(base_path+ r"4.SMOTE\tomato_unhealthy.xlsx")[:samples]
SD_Capsicum = pd.read_excel(base_path+ r"4.SMOTE\capsicum.xlsx")[:samples]
SD_potato = pd.read_excel(base_path+ r"4.SMOTE\potato.xlsx")[:samples]
SD_chilli = pd.read_excel(base_path+ r"4.SMOTE\chilli.xlsx")[:samples]
SD_mulberry = pd.read_excel(base_path+ r"4.SMOTE\mulberry.xlsx")[:samples]
...
slug="SMOTE"
cal_bi_multi_variate_plot_hellinger_distances(base_path + r"..\Results\Data_quality\\", 
                                              datasets, n_bins = 15, slug=slug, save_img=True)
