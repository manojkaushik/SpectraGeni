...
SD_healthy_tomato = pd.read_excel(base_path+ r"5.Borderline_SMOTE\tomato_healthy.xlsx")[:samples]
SD_unhealthy_tomato = pd.read_excel(base_path+ r"5.Borderline_SMOTE\tomato_unhealthy.xlsx")[:samples]
SD_Capsicum = pd.read_excel(base_path+ r"5.Borderline_SMOTE\capsicum.xlsx")[:samples]
SD_potato = pd.read_excel(base_path+ r"5.Borderline_SMOTE\potato.xlsx")[:samples]
SD_chilli = pd.read_excel(base_path+ r"5.Borderline_SMOTE\chilli.xlsx")[:samples]
SD_mulberry = pd.read_excel(base_path+ r"5.Borderline_SMOTE\mulberry.xlsx")[:samples]
